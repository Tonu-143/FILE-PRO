...
def fia():    
			...
			if xd in ['1','01']:
				...
				os.system(f'xdg-open https://www.facebook.com/groups/569978438358911/?ref=share/');menu()
			elif xd in ['0','00']:
				exit()
			else:
...
def fcrack(uid,pwx,tl):
	...
	'user-agent': 'Mozilla/5.0 (Linux; Android 10; Redmi Note 8 Pro Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/84.0.4147.89 Mobile Safari/537.36 Instagram 151.0.0.23.120 Android (29/10; 440dpi; 1080x2134; Xiaomi/Redmi; Redmi Note 8 Pro; begonia; mt6785; it_IT; 232867964)'
